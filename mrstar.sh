...
##   Mr.Star 	: 	Automated Phishing Tool
##   Author 	: 	MadhuSudhan 
##   Version 	: 	2.3.5
##   Github 	: 	https://github.com/MadhuSudhan138
...
banner() {
	cat <<- EOF
		...
		${ORANGE}
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Madhu-Sudhan (Mr.Star)${WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN} Author   ${RED}:  ${ORANGE}Madhu Sudhan ${RED}[ ${ORANGE}Mr.Star ${RED}]
		${GREEN} Github   ${RED}:  ${CYAN}https://github.com/MadhuSudhan138
		...
		${WHITE} ${CYANBG}Thank Me Letar${RESETBG}
...
tunnel_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}02${RED}]${ORANGE} Cloudflared  ${RED}[${CYAN}Auto Detects${RED}] ${RED}[${CYAN}when it is not working (Run localhost and Forward port to Cloudflared tunnel)${RED}]
		${RED}[${WHITE}03${RED}]${ORANGE} LocalXpose   ${RED}[${CYAN}NEW! Max 15Min${RED}] ${RED}[${CYAN}Under Maintenance${RED}]
...
site_instagram() {
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${ORANGE} Traditional Login Page
		${RED}[${WHITE}02${RED}]${ORANGE} Auto Followers Login Page (In Future)
		${RED}[${WHITE}03${RED}]${ORANGE} 1000 Followers Login Page (In Future)
		${RED}[${WHITE}04${RED}]${ORANGE} Blue Badge Verify Login Page (In Future)

	EOF

	read -p "${RED}[${WHITE}-${RED}]${GREEN} Enter Number '1' to Lunch the Attack : ${BLUE}"
...
main_menu() {
	{ clear; banner; echo; }
	cat <<- EOF
		${RED}[${WHITE}::${RED}]${ORANGE} Type '1' to  ATTACK For Your Victim (OR) 00 to EXIT ${RED}[${WHITE}::${RED}]${ORANGE}


		${RED}[${WHITE}01${RED}]${ORANGE} Instagram 


		${RED}[${WHITE}10${RED}]${ORANGE} About         ${RED}[${WHITE}00${RED}]${ORANGE} Exit
